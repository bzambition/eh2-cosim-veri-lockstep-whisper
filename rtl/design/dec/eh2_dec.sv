...
`include "eh2_param.vh"
  ...
  (
   ...
   output logic dec_div_cancel_overwrite, // verification-only: cancel due to younger same-rd write
...
// Debug end
   ...
   logic [4:0]                dec_i0_waddr_wb1, dec_i1_waddr_wb1;
   logic                      dec_i0_wen_wb1,   dec_i1_wen_wb1;
   logic [31:0]               dec_i0_wdata_wb1, dec_i1_wdata_wb1;
