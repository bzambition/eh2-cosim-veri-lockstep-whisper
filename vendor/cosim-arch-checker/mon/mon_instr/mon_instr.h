...
void monMem(int hart, std::uint64_t cycle, std::uint64_t addr, std::uint64_t data, std::uint32_t size, std::uint32_t mask);
void monAsync(int hart, std::uint64_t cycle, std::uint64_t mip, std::uint32_t interrupt, std::uint32_t debug_mode);
